...
(function ( $ ) {
  var elActive = '';
    $.fn.selectCF = function( options ) {
      ...
      // html +=     "<span class='titleCF' style='"+style+"; width:"+width+"px'>Menu</span>";
      ...
      $(optionSelect).bind('click', function(e){
        ...
        if( $(this).hasClass('selected') ){
          ...
          $(customSelect).children('li').children('.titleCF').html("Menu");
...
$( function() {
  ...
  if((document.URL.match("/users/edit")) || (document.URL.match("/groups/new"))) {
        $('.dropify').dropify();
    }
});
